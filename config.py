...
_C.MODEL.RESUME = ''
# Whether reuse the head if ckpt has different head dimension
_C.MODEL.REUSE_HEAD = False
...
_C.MODEL.FOCAL.FOCAL_STRIDES = [1, 1, 1, 1]
_C.MODEL.FOCAL.FOCAL_WINDOWS = [7, 5, 3, 1]
_C.MODEL.FOCAL.FOCAL_TOPK = 64
_C.MODEL.FOCAL.FOCAL_SHAPE = "circle"
_C.MODEL.FOCAL.FOCAL_ROUTING_TOPK = 64
...
_C.MODEL.FOCAL.USE_CONV_ROUTE = False
_C.MODEL.FOCAL.USE_LAYERSCALE = False
_C.MODEL.FOCAL.USE_PRE_NORM = False
_C.MODEL.FOCAL.USE_ROUTE = False
_C.MODEL.FOCAL.MUTE_FINE_GRAIN = False
_C.MODEL.FOCAL.FOCAL_KERNELS = [5, 3, 3, 3]

# Below are specifical for DW-Net
_C.MODEL.DWNET = CN()
