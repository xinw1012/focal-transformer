...
default_cfgs = {
    ...
    'vit_small_patch16_384': _cfg(
        ...
        input_size=(3, 384, 384), crop_pct=1.0),
    'vit_small_patch16_448': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_384.npz',
        input_size=(3, 448, 448), crop_pct=1.0),  
    'vit_small_patch16_896': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_384.npz',
...
def vit_small_patch16(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_small_patch16', pretrained=pretrained, **model_kwargs)
    return model
...
@register_model
def vit_small_patch16_448(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/16)
    NOTE I've replaced my previous 'small' model definition and weights with the small variant from the DeiT paper
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
    model = _create_vision_transformer('vit_small_patch16_448', pretrained=pretrained, **model_kwargs)
    return model

@register_model
def vit_small_patch16_896(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/16)
    NOTE I've replaced my previous 'small' model definition and weights with the small variant from the DeiT paper
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
    model = _create_vision_transformer('vit_small_patch16_896', pretrained=pretrained, **model_kwargs)
    return model
...
def vit_base_patch16(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_base_patch16', pretrained=pretrained, **model_kwargs)
    return model
...
if __name__ == '__main__':
    ...
    model = vit_small_patch16(img_size=224).cuda()
    output = model(x)
    profile(model, x)