    ...
    def forward(self, x_all, mask_all=None):
        ...
        if self.pool_method != "none" and self.focal_level > 1:
            ...
            for k in range(self.focal_level-1):
                ...
                qkv_pooled = self.qkv_global[k](x_window_pooled).reshape(B, nWh, nWw, 3, C).permute(3, 0, 4, 1, 2).contiguous()
...
if __name__ == '__main__':
    ...
    model = FocalTransformer(img_size=img_size, embed_dim=64, depths=[1,2,21,1], drop_path_rate=0.2, 
