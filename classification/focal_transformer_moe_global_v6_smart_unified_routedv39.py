...
class WindowAttention(nn.Module):
    ...
    def forward(self, x_all, mask_all=None):
        ...
        if self.pool_method != "none": 
            ...
            for l in range(self.focal_level):         
                if self.pool_method == "conv":
                    ...
                    x4conv_kv_all = x4conv_kv_all + x4conv_kv * self.focal_weights[l]
        ...
        x4conv_kv_all = x4conv_kv_all + x4conv_kv.mean(2, keepdim=True).mean(3, keepdim=True) * self.focal_weights[-1]
