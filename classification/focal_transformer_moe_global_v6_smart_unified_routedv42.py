...
class WindowAttention(nn.Module):
    ...
    def forward(self, x_all, mask_all=None):
        ...
        x4conv_k_all = self.v(self.act(x4conv_kv))
        ...
        x4conv_k_all = x4conv_k_all + self.v(self.act(x4conv_kv.mean(2, keepdim=True).mean(3, keepdim=True))) * self.focal_weights[-1]

        x_out = x4conv_q_all * x4conv_k_all + self.bias
